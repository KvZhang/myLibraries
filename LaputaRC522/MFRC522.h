...
public:
	...
	bool PICC_WakeupACard();
	bool PICC_ReadCardSerial();
//	unsigned char readOneByte(unsigned char blockAddr, unsigned char offsetAddr, char *returnAddr,MIFARE_Key *key);
//	unsigned char writeOneByte(unsigned char blockAddr, unsigned char offsetAddr, char data,MIFARE_Key *key);
//	unsigned char readBlock(unsigned char blockAddr, char *returnAddr, unsigned char len,MIFARE_Key *key);
//	unsigned char writeBlock(unsigned char blockAddr,  char *dataAddr, unsigned char len,MIFARE_Key *key);
